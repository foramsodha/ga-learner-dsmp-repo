...
print('Count Vector accuracy:',acc_count_nb)
print('TfIdf accuracy:',acc_tfidf_nb)
...
print('Count Vector score:',acc_count_logreg)
print('TfIdf Vector score:',acc_tfidf_logreg)
